...
Current Consortium members include RENCI, The National Institute of Environmental Health Sciences (NIEHS), Wellcome Sanger Institute, Utrecht University, University of Groningen, SURF, Maastricht University, KU Leuven, CUBI at Berlin Institute of Health, Bibliothèque et Archives nationales du Québec (BAnQ), The Council for Scientific and Industrial Research (CSIR), University of Arizona, IT4Innovations National Supercomputing Center, Globus, The George Washington University, Wageningen University and Research (WUR), The Netherlands Cancer Institute (NKI), the National Center for High-Performance Computing (NCHC), IBM, Leiden University, Scripps Research, and two organizations that wish to remain anonymous. Membership is open to anyone interested in sustaining iRODS' success and participating in the iRODS community.
...
Currently, PostgreSQL and MySQL/MariaDB are the officially supported database technologies that may be used to implement an iRODS Catalog database.
...
$ wget -qO - https://packages.irods.org/irods-signing-key.asc | \
  sudo gpg \
    ...
    --import
$ echo "deb [signed-by=/etc/apt/keyrings/renci-irods-archive-keyring.pgp arch=amd64] \
  https://packages.irods.org/apt/ @\char36@(lsb_release -sc) main" | \
...
\begin{lstlisting}
$ sudo su - irods -c "iadmin set_delay_server $(hostname -f)"
\end{lstlisting}
...
\begin{lstlisting}
irods      11519  0.0  0.9 287860 36480 ?   Sl  May15  0:18 /usr/sbin/irodsDelayServer
\end{lstlisting}
...
\begin{itemize}
 \item visit this webpage: \url{https://docs.irods.org/5.0.2/icommands/user/}
...
$ iadmin mkresc newResc unixfilesystem $(hostname -f):/var/lib/irods/new_vault
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2026/beginner/training_jpgs.zip
...
/tempZone/home/alice:
 ...
 C- /tempZone/home/alice/training_jpgs
/tempZone/home/alice/training_jpgs:
        ACL - alice#tempZone:own   bobby#tempZone:modify_object
        Inheritance - Disabled
  beans.jpg
        ACL - alice#tempZone:own   bobby#tempZone:modify_object
  coffee.jpg
...
/tempZone/home/alice/training_jpgs:
  alice             0 demoResc      1128069 2026-05-29.00:17 & beans.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/beans.jpg
  alice             0 demoResc       479299 2026-05-29.00:17 & coffee.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/coffee.jpg
  alice             0 demoResc       912548 2026-05-29.00:17 & eggs.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/eggs.jpg
  alice             0 demoResc       669306 2026-05-29.00:17 & grapes.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/grapes.jpg
  alice             0 demoResc      1312007 2026-05-29.00:17 & lemur.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/lemur.jpg
  alice             0 demoResc       392585 2026-05-29.00:17 & mouse.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/mouse.jpg
  alice             0 demoResc      1413230 2026-05-29.00:22 & peanuts.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/peanuts.jpg
  alice             0 demoResc      2555592 2026-05-29.00:17 & platter.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/platter.jpg
  alice             0 demoResc      1822077 2026-05-29.00:17 & scooter.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/scooter.jpg
  alice             0 demoResc       362833 2026-05-29.00:17 & seal.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/seal.jpg
  alice             0 demoResc          370 2026-05-29.00:17 & sources.txt
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/sources.txt
  alice             0 demoResc      1153142 2026-05-29.00:17 & waffle.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/waffle.jpg
\end{lstlisting}
...
/tempZone/home/alice/training_jpgs:
  ...
  alice             0 demoResc      1413230 2026-05-29.00:22 & peanuts.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/peanuts.jpg
  alice             1 newResc      1413230 2026-05-29.00:24 & peanuts.jpg
        generic    /var/lib/irods/new_vault/home/alice/training_jpgs/peanuts.jpg
  alice             0 demoResc      2555592 2026-05-29.00:17 & platter.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/platter.jpg
  alice             0 demoResc      1822077 2026-05-29.00:17 & scooter.jpg
        generic    /var/lib/irods/Vault/home/alice/training_jpgs/scooter.jpg
...
\url{https://docs.irods.org/5.0.2/icommands/user/}.
...
Database & \makecell[l]{PostgreSQL* \\ MariaDB* \\ MySQL*} \\
...
S3* & Amazon or other S3-compatible storage service \\
...
To set up automatic replication, we will need to use the \texttt{iadmin} command, so we will need to \texttt{iexit} out of Alice's account and log in as \texttt{rods}, the administrator account.
...
\begin{lstlisting}[basicstyle=\scriptsize\ttfamily]
$ iadmin mkresc storageResc1 unixfilesystem $(hostname -f):/var/lib/irods/storageVault1
$ iadmin mkresc storageResc2 unixfilesystem $(hostname -f):/var/lib/irods/storageVault2
\end{lstlisting}
...
\begin{lstlisting}[basicstyle=\scriptsize\ttfamily]
$ iquest "SELECT COLL_NAME, DATA_NAME WHERE META_DATA_ATTR_NAME = @\char"0D@author@\char"0D@ AND META_DATA_ATTR_VALUE = @\char"0D@AJones@\char"0D@"
...
\begin{lstlisting}[basicstyle=\scriptsize\ttfamily]
$ iquest "SELECT COLL_NAME, DATA_NAME WHERE META_DATA_ATTR_NAME = @\char"0D@author@\char"0D@ AND META_DATA_ATTR_VALUE LIKE @\char"0D@%@\char"0D@"
COLL_NAME = /tempZone/home/alice/training_jpgs
...
\begin{lstlisting}[basicstyle=\scriptsize\ttfamily]
$ iquest "SELECT COLL_NAME WHERE META_COLL_ATTR_NAME = @\char"0D@collection_type@\char"0D@ AND META_COLL_ATTR_VALUE LIKE @\char"0D@%@\char"0D@"
COLL_NAME = /tempZone/home/alice/training_jpgs
------------------------------------------------------------
\end{lstlisting}
...
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2026/beginner/example_delay.r}{\usebox{\exampleDelayRule}}
...
\begin{lstlisting}
$ sudo journalctl -f | grep "irods[Server|Agent]"
\end{lstlisting}
...
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2026/beginner/training.re}{\usebox{\lstTrainingRuleBase}}

\vspace{5mm}
\begin{lrbox}{\lstPythonRulebase}
\lstinputlisting[language=Python,basicstyle=\scriptsize\ttfamily]{core.py}
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2026/beginner/core.py}{\usebox{\lstPythonRulebase}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2026/beginner/server_config.json#L41-L45}{\usebox{\lstServerConfigA}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2026/beginner/server_config.json#L56-L59}{\usebox{\lstServerConfigB}}

Save the file, then issue the following command to reload the server configuration.

\begin{lstlisting}
$ sudo su - irods -c @\char"0D@kill -HUP $(cat /var/run/irods/irods-server.pid)@\char"0D@
\end{lstlisting}

The new rulebases will be activated!  Let's upload a new file to our home collection:

\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2026/stickers.jpg
$ iput stickers.jpg
\end{lstlisting}
...
\begin{itemize}
 ...
 \item iRODS Download --- \url{https://irods.org/download/}
 \item iRODS GitHub --- \url{https://github.com/irods}
 \item iRODS Documentation --- \url{https://docs.irods.org/}
 \item iRODS LinkedIn --- \url{https://linkedin.com/company/irods}
\end{itemize}
...
\item [iRODS Catalog]
The iRODS Metadata Catalog is a database (e.g. PostgreSQL, MySQL/MariaDB) that stores metadata about the Data Objects, Collections, Users, and Groups in an iRODS Zone. There is one iRODS Catalog per iRODS Zone.

...
\vspace{10mm}
\textbf{Durham, North Carolina, United States}
...
Rule Engine & \vspace{-3mm}\makecell[l]{iRODS Rule Language \\ Python* \\ C++ (various)* \\ Javascript* \\ Go*} \\
...
This rule engine package installs a single compiled library (shared object): \\ \texttt{/usr/lib/irods/plugins/rule\_engines/librule-engine-plugin-python.so}
...
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2018/beginner/training.re}{\usebox{\lstTrainingRuleBase}}

\vspace{5mm}
\begin{lrbox}{\lstPythonRulebase}
\lstinputlisting[language=Python,basicstyle=\scriptsize\ttfamily]{core.py}
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2018/beginner/core.py}{\usebox{\lstPythonRulebase}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2018/beginner/server_config.json#L41-L45}{\usebox{\lstServerConfigA}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2018/beginner/server_config.json#L78-L80}{\usebox{\lstServerConfigB}}

Save the file and the new rulebases will be activated!  Let's upload a new file to our home collection:

\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2018/stickers.jpg
$ iput stickers.jpg
\end{lstlisting}

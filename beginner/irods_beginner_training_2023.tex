...
Current Consortium members include RENCI, Bayer, The National Institute of Environmental Health Sciences (NIEHS), DataDirect Networks (DDN), Wellcome Sanger Institute, Utrecht University, University College London, University of Groningen, SURF, Texas Advanced Computing Center (TACC), Maastricht University, KU Leuven, CUBI at Berlin Institute of Health, Bibliothèque et Archives nationales du Québec (BAnQ), CINES, SoftIron, Minnesota Supercomputing Institute at the University of Minnesota, Omnibond, The Council for Scientific and Industrial Research (CSIR), InfiniteTactics, Fujifilm, University of Arizona, IT4Innovations National Supercomputing Center, and three organizations that wish to remain anonymous. Membership is open to anyone interested in sustaining iRODS' success and participating in the iRODS community.
...
\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2023/beginner/training_jpgs.zip
...
/tempZone/home/alice/training_jpgs:
 ...
 alice             0 demoResc      1413230 2023-04-07.14:16 & peanuts.jpg
       demoResc    generic    /var/lib/irods/Vault/home/alice/training_jpgs/peanuts.jpg
 alice             1 newResc       1413230 2023-04-07.14:37 & peanuts.jpg
...
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2023/beginner/training.re}{\usebox{\lstTrainingRuleBase}}

\vspace{5mm}
\begin{lrbox}{\lstPythonRulebase}
\lstinputlisting[language=Python,basicstyle=\scriptsize\ttfamily]{core.py}
\end{lrbox}
\href{https://raw.githubusercontent.com/irods/irods_training/ugm2023/beginner/core.py}{\usebox{\lstPythonRulebase}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2023/beginner/server_config.json#L41-L45}{\usebox{\lstServerConfigA}}
...
\end{lstlisting}
\end{lrbox}
\href{https://github.com/irods/irods_training/blob/ugm2023/beginner/server_config.json#L56-L59}{\usebox{\lstServerConfigB}}

Save the file and the new rulebases will be activated!  Let's upload a new file to our home collection:

\begin{lstlisting}
$ wget https://github.com/irods/irods_training/raw/ugm2023/stickers.jpg
$ iput stickers.jpg
\end{lstlisting}

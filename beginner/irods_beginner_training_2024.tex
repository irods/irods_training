...
\begin{lstlisting}[basicstyle=\scriptsize\ttfamily]
$ iquest "SELECT DATA_NAME, COLL_NAME WHERE META_DATA_ATTR_NAME = 'author' AND META_DATA_ATTR_VALUE = 'AJones'"
DATA_NAME = seal.jpg
...
\begin{lstlisting}[basicstyle=\scriptsize\ttfamily]
$ iquest "SELECT DATA_NAME, COLL_NAME WHERE META_DATA_ATTR_NAME = 'author' AND META_DATA_ATTR_VALUE LIKE '%'"
